export default ({
    ...
    UI_Property_Intelligence: 'TEC',
    UI_Property_Strength: 'MOR',
    UI_Property_Money: 'BIZ',
    UI_Property_Spirit: 'SPR',

    UI_Title_Remake: 'My Binance Life: Reborn',
    UI_Title_Subsequent: 'Let\'s zero out and restart',
    UI_Remake: '↻Remake Now',
    UI_Thanks: 'Thx',
    UI_Achievement: 'Achv',
    UI_Cyber_Theme_Art_Design: 'UI Design by 晰晰',
    UI_Banner: 'Play as CZ, relive crypto history — rise, fall, or open a noodle shop.',

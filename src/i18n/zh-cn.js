export default ({
    ...
    UI_Property_Charm: '魅力',
    UI_Property_Intelligence: '技术力',
    UI_Property_Strength: '道德底线',
    UI_Property_Money: '商业嗅觉',
    UI_Property_Spirit: '快乐',

    UI_Title_Remake: '转生之我的币安人生',
    UI_Title_Subsequent: '这把必须归零一次再重开',
    UI_Remake: '↻立即重开',
    UI_Thanks: '感谢',
    UI_Achievement: '成就',
    UI_Cyber_Theme_Art_Design: 'UI 设计 by 晰晰',
    UI_Banner: '扮演CZ重走币圈一生 — 有人上岸,有人坐牢,有人去卖拉面',
    ...
    F_PropertyStr: '魅力{CHR} 技术力{INT} 道德{STR} 商嗅{MNY}'
});